...
namespace Itoufo\Notifer\Models;
...
class Notification extends Model
{
     ...
     *
     * @param array|\Itoufo\Notifer\Builder\Notification $attributes
     */
    public function __construct($attributes = [])
    {
        $table = app('notifer.resolver.model')->getTable(get_class($this));
        if (! empty($table)) {
            $this->setTable($table);
        }
    ...
    public function from()
    {
        ...
        return $this->belongsTo(notifer_config()->getNotifiedModel(), 'from_id');
    }
    ...
    public function to()
    {
        ...
        return $this->belongsTo(notifer_config()->getNotifiedModel(), 'to_id');
    }
    ...
    {
        return notifer_config()->getAdditionalFields();
    }
    ...
    /**
     * @return string
     * @throws \Itoufo\Notifer\Exceptions\ExtraParamsException
     */
    public function getTextAttribute()
    {
        if (! array_key_exists('text', $this->attributes)) {
            $notiferParse = new NotificationParser();
            $this->attributes['text'] = $notiferParse->parse($this);
        }
