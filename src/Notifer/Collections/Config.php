...
namespace Itoufo\Notifer\Collections;
...
class Config implements ConfigContract
{
    ...
    {
        return $this->get('translation.domain', 'notifer');
    }
    ...
    public function set($key, $value = null)
    {
        ...
        app('config')->set('notifer.'.$key, $value);
    }
    ...
    public function forget($key)
    {
        ...
        app('config')->offsetUnset('notifer.'.$key);
    }

    public function reload()
    {
        $this->items = app('config')->get('notifer');
    }
