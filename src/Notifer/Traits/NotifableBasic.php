...
trait NotifableBasic
{
    ...
    public function getNotificationRelation($eagerLoad = null)
    {
        ...
        if (is_null($eagerLoad)) {
            $eagerLoad = notifer_config('eager_load', false);
        }
    ...
    /**
     * Get a new NotiferManager instance with the given category.
     *
     * @param string|int|\Itoufo\Notifer\Models\NotificationCategory $category
     * @return \Itoufo\Notifer\Managers\NotiferManager
     */
    public function notifer($category)
    {
        return app('notifer')->category($category);
    }

    /**
     * Get a new NotiferManager instance with the given category and $this as the sender.
     *
     * @param string|int|\Itoufo\Notifer\Models\NotificationCategory $category
     * @return \Itoufo\Notifer\Managers\NotiferManager
     */
    ...
    {
        return $this->notifer($category)->from($this);
    }

    /**
     * Get a new NotiferManager instance with the given category and $this as the receiver.
     *
     * @param string|int|\Itoufo\Notifer\Models\NotificationCategory $category
     * @return \Itoufo\Notifer\Managers\NotiferManager
     */
    ...
    {
        return $this->notifer($category)->to($this);
    }
