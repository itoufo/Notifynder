...
return [
     ...
     * considerate if using notifer as polymorphic
     */
    'model' => 'App\User',

    /*
     * Do you want notifer to eager load its related models?
    ...
    /*
     * Do you want have notifer that work polymorphically?
